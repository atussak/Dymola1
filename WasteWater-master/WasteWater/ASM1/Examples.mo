...
"));
  ...
  class BSM1 "COST Benchmark WWTP Configuration"
    ...
    Modelica.Blocks.Sources.Constant Temperature(k=15)
      annotation (Placement(transformation(extent={{-96,47},{-84,59}})));
  ...
  equation
    ...
    connect(Temperature.y, tank1.T)
      annotation (Line(points={{-83.4,53},{-80,53},{-80,33},{-78,33}},   color=
            {0,0,255}));
    connect(Temperature.y, tank2.T)
      annotation (Line(points={{-83.4,53},{-54,53},{-54,33},{-50,33}}, color={0,
            0,255}));
    connect(Temperature.y, tank3.T) annotation (Line(points={{-83.4,53},{-54,53},
            {-54,11},{-62,11},{-62,5},{-61.5,5},{-62,5}},               color={
            0,0,255}));
    connect(Temperature.y, tank4.T) annotation (Line(points={{-83.4,53},{-54,53},
            {-54,11},{-34,11},{-34,5}}, color={0,0,255}));
    connect(Temperature.y, tank5.T) annotation (Line(points={{-83.4,53},{-54,53},
            {-54,11},{-7.9,11},{-7.9,5},{-8,5}},   color={0,0,255}));
