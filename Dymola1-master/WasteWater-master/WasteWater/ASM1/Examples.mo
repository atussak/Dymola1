...
package Examples "Demonstration examples of the components of the ASM1 library"
  ...
  class SmallPlant "Small WWTP Configuration"
    ...
    ASM1.EffluentSink Effluent annotation (Placement(transformation(extent={{83,-26},
              {103,-6}})));
    ASM1.SludgeSink WasteSludge annotation (Placement(transformation(extent={{
              87,-51},{107,-31}})));
    ASM1.divider2 divider annotation (Placement(transformation(extent={{22,-9},
              {42,11}})));
    ASM1.nitri tank3(V=1333) annotation (Placement(transformation(extent={{-5,-6},
              {15,14}})));
    ...
    ASM1.deni tank1(V=3000) annotation (Placement(transformation(extent={{-65,
              -6},{-45,14}})));
    ASM1.mixer3 mixer annotation (Placement(transformation(extent={{-102,23},{
              -82,43}})));
    ...
    ASM1.blower blower2(Q_max=34574.2654508612) annotation (Placement(
          transformation(extent={{-5,-62},{15,-42}})));
    ...
    WasteWater.ASM1.sensor_TSS sensor_TSS1 annotation (Placement(transformation(
            extent={{32,14},{49,30}})));
  equation
    connect(tank3.Out, divider.In) annotation (Line(points={{15,4},{17,4},{17,
            1.3},{22,1.3}}));
    connect(mixer.Out, tank1.In) annotation (Line(points={{-82,32.6},{-77,32.6},
            {-77,4},{-65,4}}));
    connect(mixer.In1, WWSource.Out) annotation (Line(points={{-102,36.5},{-102,
    ...
    connect(PI1.y, blower2.u) annotation (Line(points={{109,50},{114,50},{114,
            -84},{18,-84},{18,-55},{14.8,-55}}));
    connect(divider.Out2, RecyclePump.In) annotation (Line(points={{42,-0.5},{
            44,-0.5},{44,-8.7},{-74,-8.7}}));
    ...
    connect(ReturnPump.Out, mixer.In2) annotation (Line(points={{16,-28.8},{
            15.5,-28.8},{15.5,-30},{-112,-30},{-112,32.5},{-102,32.5}}));
    connect(sensor_O2.So, Feedback.u2)
      annotation (Line(points={{20.8,35},{72,35},{72,42}}));
    ...
    connect(Temperature.y, tank3.T) annotation (Line(points={{-81.4,56},{-39,56},
            {-39,14},{-5.9,14},{-5.9,8},{-5,8}},   color={0,0,255}));
    ...
    connect(WastePump.u, Constant2.y)
      annotation (Line(points={{60.1,-42.5},{46,-42.5},{46,-58},{43,-58}},
                                                                     color={0,0,
            255}));
    connect(tank2.Out, tank3.In) annotation (Line(points={{-14,4},{-10,4},{-5,4}}));
    ...
    connect(divider.Out1, Settler.Feed) annotation (Line(points={{42,3.6},{44.5,
            3.6},{44.5,7.4},{48,7.4}}));
...
"));
  ...
  class BenchPlant "COST Benchmark WWTP Configuration"
    ...
    ASM1.nitri tank3(V=1333,
      ...
      K_x_T=0.1,
      K_s=10,
      ny_h=0.8)              annotation (Placement(transformation(extent={{-60,
              -6},{-40,14}})));
    ASM1.deni tank1(
      i_xb=0.08,
      b_h_T=0.3,
    ...
    ASM1.deni tank6(
      ...
      K_x_T=0.1,
      K_s=10,
      ny_h=0.8)     annotation (Placement(transformation(extent={{-46,22},{-26,
              42}})));
    ASM1.nitri tank2(V=1333,
      ...
      K_x_T=0.1,
      K_s=10,
      ny_h=0.8)              annotation (Placement(transformation(extent={{-30,-6},
              {-10,14}})));
    ASM1.nitri tank4(V=1333,
      ...
      K_x_T=0.1,
      K_s=10,
      ny_h=0.8)              annotation (Placement(transformation(extent={{-5,-6},
              {15,14}})));
  equation
    ...
    connect(tank6.In, tank1.Out) annotation (Line(
        points={{-46,32},{-56,32}},
        color={0,0,255},
        smooth=Smooth.None));
    connect(tank6.MeasurePort, sensor_NO.In) annotation (Line(
        points={{-30.5,36.5},{-36.75,36.5},{-36.75,48},{-32,48}},
        color={0,0,0},
        smooth=Smooth.None));
    connect(tank6.T, tank3.T) annotation (Line(
        points={{-46,36},{-50,36},{-50,35},{-52,35},{-52,14},{-60,14},{-60,8}},

        color={0,0,127},
        smooth=Smooth.None));
    connect(tank6.Out, tank3.In) annotation (Line(
        points={{-26,32},{-21,32},{-21,20},{-68,20},{-68,4},{-60,4}},
        color={0,0,0},
        smooth=Smooth.None));
    connect(tank3.Out, tank2.In) annotation (Line(
        points={{-40,4},{-30,4}},
        color={0,0,0},
        smooth=Smooth.None));
    connect(tank4.In, tank2.Out) annotation (Line(
        points={{-5,4},{-10,4}},
        color={0,0,255},
        smooth=Smooth.None));
    connect(tank4.Out, divider.In) annotation (Line(
        points={{15,4},{18,4},{18,4.3},{20,4.3}},
        color={0,0,0},
        smooth=Smooth.None));
    connect(tank4.AirIn, blower3.AirOut) annotation (Line(
        points={{5,-5.8},{5,-24},{5,-42},{3,-42}},
        color={0,0,0},
        smooth=Smooth.None));
    connect(tank2.AirIn, blower2.AirOut) annotation (Line(
        points={{-20,-5.8},{-21,-5.8},{-21,-42},{-23,-42}},
        color={0,0,0},
        smooth=Smooth.None));
    connect(tank4.MeasurePort, sensor_O2.In) annotation (Line(
        points={{10.5,8.5},{10.5,16.25},{9.5,16.25},{9.5,25}},
        color={0,0,0},
        smooth=Smooth.None));
    connect(tank4.T, tank3.T) annotation (Line(
        points={{-5,8},{-8,8},{-8,15},{-8,15},{-8,20},{-10,20},{-10,14},{-60,14},
            {-60,8}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(tank2.T, tank3.T) annotation (Line(
        points={{-30,8},{-38,8},{-38,12},{-37,12},{-37,10},{-36,10},{-36,18},{
            -36,18},{-36,18},{-60,18},{-60,8}},
        color={0,0,127},
        smooth=Smooth.None));
    annotation (
      Diagram(coordinateSystem(
